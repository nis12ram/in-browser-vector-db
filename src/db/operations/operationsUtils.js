...
export class OperationsUtils {
    ...
    */
    ...
    /**
    * The specified vector dimension matches with the configured dimension.
    *
    * @param {Array} vector - The specified vector.
    * @param {number} dimenion - The configured dimenion.
    *
    * @returns {Boolean} true if dimension matches ,otherwise false.
    */
    ...
    /**
    * The specified vector dType matches with the configured dType.
    *
    * @param {Array} vector - The specified vector.
    * @param {string} dType - The configured dType.
    *
    * @returns {Boolean} true if dType matches ,otherwise false.
    */
    ...
    */
    ...
    /**
    * The template for storing topK result.
    *
    * @param {number} topK - The top k search result.
    *
    * @returns {Array<[{},distance]>} The template
    */
